...
variable "recon_instance_type" {          # Defines the computational specifications and resources of the EC2 instance, such as CPU, memory, storage and network capacity.
    type = string
